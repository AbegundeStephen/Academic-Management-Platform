...
export class CoursesController {
  ...
  @ApiResponse({
    status: 400,
    description: 'Bad request - Course code already exists',
  })
  ...
  @ApiOperation({
    summary: 'Update a course (Admin or assigned lecturer only)',
  })
  @ApiResponse({ status: 200, description: 'Course updated successfully' })
  @ApiResponse({
    status: 403,
    description: 'Forbidden - No permission to update this course',
  })
  @ApiResponse({ status: 404, description: 'Course not found' })
  update(

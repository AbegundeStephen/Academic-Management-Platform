...
export class RecommendationResponseDto {
    ...
    @ApiProperty({ example: 'Course Recommendations', description: 'Title of the recommendation' })
    title: string;
...
export class StudyPathRecommendationDto {
    @ApiProperty({ example: 'Full Stack Web Development', description: 'Study path title' })
    title: string;

    @ApiProperty({ example: 'Complete path to become a full stack developer', description: 'Study path description' })
    description: string;
...
export class PerformanceInsightDto {
    @ApiProperty({ example: 'Mathematics', description: 'Subject or course name' })
    subject: string;
    ...
    @ApiProperty({
        example: { strengths: ['Algebra', 'Geometry'], weaknesses: ['Calculus', 'Statistics'] },
